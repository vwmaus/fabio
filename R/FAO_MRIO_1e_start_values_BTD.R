#' @title FAO_MRIO_1e_start_values_BTD
#' @author Sebastian Luckeneder, \email{sebastian.luckeneder@@wu.ac.at}
#' 
#' @description Build MRIO table based on Faostat commodity balance sheets and trade data part 1e: define start values for BTD
#' 
#' @param ... some argument 
#' 
...
#' 
#' @export
FAO_MRIO_1e_start_values_BTD <- function(...){
